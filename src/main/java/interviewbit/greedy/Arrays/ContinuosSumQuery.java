...
public class ContinuosSumQuery {
     ...
     * 0 <= len(B) <= 105
     * <p>
     * Check if Integer overflow will happen or not
     * (105 )* (103)* (2* 105) => (no of devotees) * (maximum coin given to first beggar) * (no of beggars)
     */
